...
describe('buildSendComponents — end-to-end mix', () => {
  ...
  it('builds per-card send components for a carousel template', () => {
    const components = buildSendComponents(
      row({
        ...
        carousel_cards: [
          {
            header_type: 'image',
            header_media_url: 'https://x.com/one.jpg',
            body_text: 'Offer {{1}} is ready.',
            buttons: [
              { type: 'URL', text: 'Book', url: 'https://x.com/{{1}}' },
            ],
          },
          {
            header_type: 'image',
            header_media_url: 'https://x.com/two.jpg',
            body_text: 'Offer {{1}} is ready.',
            buttons: [
              { type: 'URL', text: 'Book', url: 'https://x.com/{{1}}' },
            ],
      ...
      {
        carouselCards: [
          { body: ['one'], buttonParams: { 0: 'one' } },
          { body: ['two'], buttonParams: { 0: 'two' } },
        ],
      }
    );
  ...
  it('uses stored carousel media when a caller sends a blank override', () => {
    const components = buildSendComponents(
      row({
        template_type: 'carousel',
        body_text: 'Choose an offer.',
        carousel_cards: [
          {
            header_type: 'image',
            header_media_url: 'https://x.com/stored.jpg',
            body_text: 'Stored media',
          },
        ],
      }),
      { carouselCards: [{ headerMediaUrl: '  ' }] }
    );
          ...
          components: [
            {
              type: 'header',
              parameters: [
                { type: 'image', image: { link: 'https://x.com/stored.jpg' } },
              ],
            },
          ],
        },
