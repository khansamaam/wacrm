...
export async function PATCH(
  ...
  // Workspace check before we touch anything. `user_id` records who
  // created the automation, but account teammates share automations.
  // Load the fields needed to validate the effective post-patch state.
